...
| **Ownership** | Within a task or piece of work, the named human accountable for the outcome they direct. Work can be delegated; ownership cannot. This does not transfer accountability for a model, product or deployment away from the organization that builds, releases or operates it. |
